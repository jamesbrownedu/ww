...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ao(e,t,n){let r=new Float32Array(go),i=new J(0,1,0);return new Qi({name:`SphericalGaussianBlur`,defines:{n:go,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:No(),fragmentShader:`
	...
	`}var Po=class extends Ht{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1};this.texture=new Ii([n,n,n,n,n,n]),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`;var Ml=new Tl(new Al,{mount:document.querySelector(`#viewport`),roomName:document.querySelector(`#room-name`),roomDescription:document.querySelector(`#room-description`),profileName:document.querySelector(`#profile-name`),transportMode:document.querySelector(`#transport-mode`),voiceMode:document.querySelector(`#voice-mode`),sessionState:document.querySelector(`#session-state`),roomList:document.querySelector(`#room-list`),occupantList:document.querySelector(`#occupant-list`),centerOverlay:document.querySelector(`#center-overlay`),enterButton:document.querySelector(`#enter-button`),footerStatus:document.querySelector(`#footer-status`)});Ml.init().catch(e=>{let t=e instanceof Error?e.message:String(e);Ml.setStartupFailure(t),console.error(e)});